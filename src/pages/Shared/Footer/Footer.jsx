...
const Footer = () => {
  ...
  <div>
    ...
    <a className="link link-hover">Email: chakrabortyshuva216@gmail.com</a>
  ...
  <div>
    ...
    <div className="grid grid-flow-col gap-4">
      <a  href="https://www.facebook.com/profile.php?id=100009952750113" target="_blank"> <img src={facebook} width="24" height="24"></img></a>
      <a  href="https://api.whatsapp.com/send?phone=01872451678&text=Hello this is the starting message" target="_blank"> <img src={whatsapp} width="24" height="24"></img></a>
      <a  href="https://www.linkedin.com/in/shuva-chakraborty-7aa59818a/" target="_blank"> <img src={linkedin} width="24" height="24"></img></a>
