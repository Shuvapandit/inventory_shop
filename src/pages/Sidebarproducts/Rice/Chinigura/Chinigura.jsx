...
const Chinigura = () => {
    ...
    // Filter products containing "oil" in their names
    const chinigurarice = products.filter(product =>
      product.name.toLowerCase().includes('chinigura')
    );
  ...
  return (
    <div className="mb-12">
        ...
        <img src="https://i.ibb.co/3Nhnnjw/mpimage.webp" className="w-full"/>
        </div>
        <h2 className="text-lg mt-3 mb-5 font-semibold "> Chinigura Rice </h2>
      <div className="grid grid-cols-2 gap-4">
        {chinigurarice.map(product => (
      ...
      {isModalOpen && selectedProduct && (
        <dialog id="my_modal_3" className="modal ml-36" open>
          <form method="dialog" className="modal-box w-96 h-11/12">
            ...
            <figure>
              <img src={selectedProduct.image} className="h-52" alt={selectedProduct.name} />
            </figure>
