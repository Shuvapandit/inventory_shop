...
const Flour = () => {
  ...
  const flour = products.filter((product) =>
    ...
    <div>
      <div className="mb-12">
        <div className=" ml-[-20px]">
          <img
            src="https://i.ibb.co/hfk5X9W/Atta-Banner-min.webp"
            className="w-full h-56"
          />
        </div>
        <h2 className="text-lg mt-3 mb-5 font-semibold  "> Flour </h2>
        <div className="grid grid-cols-2 gap-4 mr-4 ml-4">
          {flour.map((product) => (
            <div
              key={product._id}
